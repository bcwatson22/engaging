...
/* connect-src is spelled out rather than left to fall back to default-src:
   the form posts cross-origin to engaging-service, and Vercel's analytics
...
/* The CV PDF and splash screens are rendered by engaging-worker and stored in
   R2, rather than built here. The bucket's public URL is rate-limited by Cloudflare and not
